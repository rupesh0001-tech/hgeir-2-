    ...
    <section ref={schemesRef} className="relative h-[400vh]">
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        ...
        >
          ...
          <button className="bg-[#1a8a5e] hover:bg-[#0e5a3d] text-white text-[10px] font-bold px-8 md:px-10 py-4 rounded-xl tracking-widest uppercase flex items-center self-start shadow-xl transition-all group">
