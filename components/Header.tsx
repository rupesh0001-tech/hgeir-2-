      ...
      >
        ...
        <div className="flex items-center justify-between w-full max-w-6xl mx-auto">
          ...
          <Link href="/" className="flex items-center space-x-2 shrink-0 group">
            <div className="w-6 h-6 bg-[#1a8a5e] rounded-tl-full rounded-br-full rounded-tr-sm rounded-bl-sm flex items-center justify-center text-white text-[10px] shrink-0 shadow-md group-hover:scale-105 transition-transform duration-300">
              🌱
            </div>
